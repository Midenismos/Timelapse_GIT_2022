...
namespace FronkonGames.SpritesMojo
{
  ...
  public static class Retro
  {
    ...
    /// <summary>
    /// Retro effect type, default Emulations.Gameboy.
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly EnumVariable Emulation = new EnumVariable("_Emulation", Emulations.Gameboy);

    /// <summary>
    /// Pixel size, default 4 [1 - 10].
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly IntVariable Pixelation = new IntVariable("_Pixelation", 4);

    /// <summary>
    /// Adjust in luminance, default 3.0 [0.0 - 10.0].
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly FloatVariable Luminance = new FloatVariable("_Luminance", 3.0f);
