...
namespace FronkonGames.SpritesMojo
{
  ...
  {
    /// <summary>
    /// Swirl strength, default 0.0 [0.0 - 1.0].
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly FloatRangeVariable Strength = new FloatRangeVariable("_Strength", 0.0f, 0.0f, 1.0f);

    /// <summary>
    /// Swirl torsion, default 0.5 [-5.0 - 5.0].
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly FloatVariable Torsion = new FloatVariable("_Torsion", 0.5f);

    /// <summary>
    /// Swirl center position, default (0.5, 0.5).
    /// </summary>
    /// <returns>Value.</returns>
