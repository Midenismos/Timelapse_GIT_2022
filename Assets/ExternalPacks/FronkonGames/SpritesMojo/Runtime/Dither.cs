...
namespace FronkonGames.SpritesMojo
{
  ...
  /// <summary>
  /// Apply various color reduction algorithms.
  /// </summary>
  public static class Dither
  {
    /// <summary>
    /// Dithering algorithms, default DitherMode.Bayer4x4.
    /// </summary>
    /// <returns>Value.</returns>
    public static EnumVariable Mode = new EnumVariable("_Dithering", DitherMode.Bayer4x4, (material, value) =>
    {
    ...
    /// <summary>
    /// Amount of color reduction, default 0.125 [0.001 - 1.0].
    /// </summary>
    /// <returns>Value.</returns>
    public static FloatRangeVariable ColorReduction = new FloatRangeVariable("_PaletteSpace", 0.125f, 0.001f, 1.0f);

    /// <summary>
    /// Pixelation, default 4 [1]
    /// </summary>
    /// <returns>Value.</returns>
    public static IntRangeVariable PixelSize = new IntRangeVariable("_Pixelation", 4, 1, 10);
