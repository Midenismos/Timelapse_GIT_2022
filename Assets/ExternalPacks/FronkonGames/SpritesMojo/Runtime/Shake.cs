...
namespace FronkonGames.SpritesMojo
{
  ...
  {
    /// <summary>
    /// Shake amplitude, default (2.0, 0.0).
    /// </summary>
    /// <returns></returns>
    public static readonly VectorVariable Amplitude = new VectorVariable("_Amplitude", new Vector2(2.0f, 0.0f));

    /// <summary>
    /// Shake intensity, default (1.0, 1.0).
    /// </summary>
    /// <returns></returns>
    public static readonly VectorVariable Intensity = new VectorVariable("_Intensity", new Vector2(1.0f, 1.0f));

    /// <summary>
    /// Shake velocity, default 1.0 [0.0 - 10.0].
    /// </summary>
    /// <returns></returns>
    public static readonly FloatVariable Speed = new FloatVariable("_Speed", 1.0f);
