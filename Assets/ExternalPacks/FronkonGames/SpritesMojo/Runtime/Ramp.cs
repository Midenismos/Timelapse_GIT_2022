...
{
  /// <summary>
  /// Apply a 5-color gradient based on lightness.
  /// </summary>
  public static class Ramp
  {
    /// <summary>
    /// First color of the gradient (lower luminosity).
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly ColorVariable Color0 = new ColorVariable("_RampColor0", Color.white * 0.2f);

    /// <summary>
    /// Second color of the gradient.
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly ColorVariable Color1 = new ColorVariable("_RampColor1", Color.white * 0.4f);

    /// <summary>
    /// Third color of the gradient.
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly ColorVariable Color2 = new ColorVariable("_RampColor2", Color.white * 0.6f);

    /// <summary>
    /// Fourth color of the gradient.
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly ColorVariable Color3 = new ColorVariable("_RampColor3", Color.white * 0.8f);

    /// <summary>
    /// Fifth color of the gradient (greater luminosity).
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly ColorVariable Color4 = new ColorVariable("_RampColor4", Color.white * 1.0f);

    /// <summary>
    /// Reverse the order of the colors.
    /// </summary>
    /// <returns></returns>
    public static readonly KeywordVariable Invert = new KeywordVariable("INVERT_RAMP", false);

    /// <summary>
    /// Luminance range that will be used to change colors, default (0.0, 0.25).
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly FloatMinMaxVariable Luminance = new FloatMinMaxVariable("_LumRangeMin", "_LumRangeMax", (0.0f, 0.25f), (0.0f, 1.0f));
    ...
    /// <summary>
    /// Sort the current gradient according to the luminosity of each color.
    /// </summary>
    /// <param name="material">The material.</param>
    ...
    public static void AutoLuminance(Material material, Texture texture)
    {
      ...
      MaterialExtensions.AutoLuminance(texture, out minLuminance, out maxLuminance);
