...
namespace FronkonGames.SpritesMojo
{
  ...
  {
    /// <summary>
    /// Edge mode, default EdgeMode.Standard.
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly EnumVariable Mode = new EnumVariable("_EdgeMode", EdgeMode.Standard, (material, value) =>
    {
    ...
    /// <summary>
    /// Algorithms used to enhance the edges, default SobelFunction.Scharr.
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly EnumVariable Sobel = new EnumVariable("_SobelFunction", SobelFunction.Scharr, (material, value) =>
    {
    ...
    /// <summary>
    /// Color used to enhance the edges.
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly ColorVariable Tint = new ColorVariable("_EdgeTint", Color.cyan);
