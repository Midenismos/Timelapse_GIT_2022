...
namespace FronkonGames.SpritesMojo
{
  ...
  /// <summary>
  /// Mimics Instagram effects.
  /// </summary>
  public static class Instagram
  {
    /// <summary>
    /// Effect type, default InstagramFilter._1977.
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly EnumVariable Filter = new EnumVariable("_Filter", InstagramFilter._1977, (material, value) =>
    {
    ...
    /// <summary>
    /// Use a contrast effect used in films, default false.
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly BoolVariable FilmContrast = new BoolVariable("_FilmContrast", false);
