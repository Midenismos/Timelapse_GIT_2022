...
{
  /// <summary>
  /// Create a 'Black Hole' effect inside the sprite.
  /// </summary>
  public static class BlackHole
  {
    /// <summary>
    /// Effect radius, default 0.1 [0.0 - 1.0].
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly FloatRangeVariable Radius = new FloatRangeVariable("_Radius", 0.1f, 0.0f, 1.0f);

    /// <summary>
    /// Effect center.
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly VectorVariable Center = new VectorVariable("_Center", new Vector2(0.5f, 0.5f));

    /// <summary>
    /// Effect distortion, default 0.1 [0.0 - 1.0].
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly FloatRangeVariable Distortion = new FloatRangeVariable("_Distortion", 0.1f, 0.0f, 1.0f);

    /// <summary>
    /// Effect color.
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly ColorVariable Color = new ColorVariable("_BlackHoleColor", new Color(0.0f, 0.0f, 0.0f, 0.8f));
