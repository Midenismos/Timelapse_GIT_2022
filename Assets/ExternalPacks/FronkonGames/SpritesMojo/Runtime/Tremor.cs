...
{
  /// <summary>
  /// It makes it look like the sprite trembles.
  /// </summary>
  public static class Tremor
  {
    /// <summary>
    /// Tremors speed, default 5.0 [0.0 - 10.0].
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly FloatRangeVariable Velocity = new FloatRangeVariable("_Velocity", 5.0f, 0.0f, 10.0f);

    /// <summary>
    /// Noise force, default 0.1 [0.0 - 1.0].
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly FloatRangeVariable NoiseScale = new FloatRangeVariable("_NoiseScale", 0.1f, 0.0f, 1.0f);

    /// <summary>
    /// Tremors intervals, default 0.1 [0.0 - 10.0].
    /// </summary>
    /// <returns>Value.</returns>
    public static readonly FloatRangeVariable NoiseSnap = new FloatRangeVariable("_NoiseSnap", 0.1f, 0.0f, 10.0f);
