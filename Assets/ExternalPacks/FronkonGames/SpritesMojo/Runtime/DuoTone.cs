...
{
  /// <summary>
  /// Apply a two color gradient based on lightness.
  /// </summary>
  public static class DuoTone
  {
    /// <summary>
    /// First color, the brightest, default White.
    /// </summary>
    /// <returns>Value.</returns>
    public static ColorVariable BrightColor = new ColorVariable("_BrightColor", Color.white);

    /// <summary>
    /// Second color, darker, default black.
    /// </summary>
    /// <returns>Value.</returns>
    public static ColorVariable DarkColor = new ColorVariable("_DarkColor", Color.black);

    /// <summary>
    /// Threshold between the two colors, default 0.25 [0.0 - 1.0].
    /// </summary>
    /// <returns>Value.</returns>
    public static FloatRangeVariable Threshold = new FloatRangeVariable("_Threshold", 0.25f, 0.0f, 1.0f);

    /// <summary>
    /// Smoothness between the two colors, default 0.25 [0.0 - 1.0].
    /// </summary>
    /// <returns>Value.</returns>
    public static FloatRangeVariable Softness = new FloatRangeVariable("_Softness", 0.25f, 0.0f, 1.0f);

    /// <summary>
    /// Luminance range that will be used to change colors, default (0.0, 0.25).
    /// </summary>
    /// <returns>Value.</returns>
    public static FloatMinMaxVariable Luminance = new FloatMinMaxVariable("_LumRangeMin", "_LumRangeMax", (0.0f, 0.25f), (0.0f, 1.0f));
